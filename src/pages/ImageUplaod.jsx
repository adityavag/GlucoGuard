...
// Separate component for DR grade reference
const DRReference = () => (
  <div className="mt-4 p-4 bg-blue-50 shadow rounded-md text-sm">
    <h3 className="font-bold text-blue-800">DR Grade Reference:</h3>
          ...
          {response && (
            <div className="mt-4 p-4 bg-white shadow rounded-md text-sm">
              ...
              <pre className="text-gray-600">
                DR Grade : {JSON.stringify(response["prediction"]["dr_grade"], null, 2)}
              </pre>
              {/* DR Grade reference shown separately */}
              <DRReference />
            </div>
          )}
        </div>
